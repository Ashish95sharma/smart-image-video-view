...
var SmartImage = ({
  ...
  if (isVideo) {
    ...
    return /* @__PURE__ */ jsx("div", { ref: containerRef, style: wrapperStyle2, "aria-busy": false, children: /* @__PURE__ */ jsx(
      "iframe",
      {
        src: embedSrc,
        title: alt ?? "video",
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, style: wrapperStyle, "aria-busy": !loaded, children: [
    !hasGallery && blurUpSrc && !loaded && !error && /* @__PURE__ */ jsx(
      "img",
      {
        src: blurUpSrc,
        alt,
    ...
    !loaded && !error && !blurUpSrc && (loader ?? /* @__PURE__ */ jsx("div", { style: { width: "100%", height: "100%", background: "#eee" } })),
    inView && /* @__PURE__ */ jsx(
      "img",
      {
        ref: imgRef,
    ...
    error && fallback && loaded === false && /* @__PURE__ */ jsx("img", { src: fallback, alt, style: { width: "100%", height: "100%", objectFit: cover ? "cover" : "contain" } }),
    gallerySources.length > 1 && /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 8, marginTop: 8, overflowX: "auto", paddingBottom: 4 }, children: gallerySources.map((thumbSrc, i) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => {
          setCurrentIndex(i);
        ...
        children: /* @__PURE__ */ jsx("img", { src: thumbSrc, alt, style: { width: 64, height: 64, objectFit: "cover", borderRadius: 4 }, loading: "lazy" })
      },
      thumbSrc + i
    )) }),
    viewerOpen && /* @__PURE__ */ jsxs(
      "div",
      {
        role: "dialog",
        "aria-modal": "true",
        ...
        children: [
          ...
          gallerySources.length > 1 && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: (e) => {
...
var ControlButton = ({ children, style, disabled, ...props }) => /* @__PURE__ */ jsx(
  "button",
  {
    ...props,
    disabled,
